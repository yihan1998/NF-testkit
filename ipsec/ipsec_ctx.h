...
struct encrypt_pipes {
	struct doca_flow_pipe *encrypt_pipe;		/* encryption action pipe */
...
/*
 * Create and start all the resources for IPSec job
 *
 * @app_cfg [in]: application configuration structure
 * @return: DOCA_SUCCESS on success and DOCA_ERROR otherwise
 */
doca_error_t ipsec_security_gw_ipsec_ctx_create(struct ipsec_security_gw_config *app_cfg);
 ...
 * @return: DOCA_SUCCESS on success and DOCA_ERROR otherwise
 */
doca_error_t ipsec_security_gw_ipsec_ctx_destroy(const struct ipsec_security_gw_config *app_cfg);
/*
 * Send create SA job to DOCA ipsec library
 *
...
/*
 * Send destroy SA job to DOCA ipsec library
 *
 * @app_cfg [in]: application configuration structure
 * @sa [in]: sa object to destroy
 * @return: DOCA_SUCCESS on success and DOCA_ERROR otherwise
 */
doca_error_t ipsec_security_gw_destroy_ipsec_sa(struct ipsec_security_gw_config *app_cfg, struct doca_ipsec_sa *sa);
/*
