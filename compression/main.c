...
/* Port configuration */
#define	JUMBO_FRAME_MAX_SIZE	4096
...
int install_flow_rule() {
    uint16_t portid;
	RTE_ETH_FOREACH_DEV(portid) {
        create_flow(portid, rte_get_main_lcore(), NR_COMPRESS);
        add_drop(portid);
    }
